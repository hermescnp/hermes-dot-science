...
import OptimizedFeatureCard from "@/components/optimized-feature-card"
import {
  BotIcon,
  SparklesIcon,
  DatabaseIcon,
...
export default function OptimizedFeaturesSection() {
  // Set up section observer
  useSectionObserver("features")
  ...
  return (
    <section className="pt-36 pb-20 bg-muted/50 dark:bg-muted/10" id="features" aria-labelledby="features-heading">
