  ...
  return (
    <>
      ...
      <div
        ...
        style={{
          backgroundImage: `linear-gradient(to right, rgba(10, 94, 149, 0.2) 0.5px, transparent 0.5px),
  linear-gradient(to bottom, rgba(10, 94, 149, 0.2) 0.5px, transparent 0.5px)`,
      ...
      <div
        ...
        style={{
          background: "radial-gradient(70% 70% at 50% 50%, transparent 0%, rgba(10, 94, 149, 0.05) 100%)",
        }}
        aria-hidden="true"
      />
    </>
