...
export default function FramerSpotlight() {
  ...
  const spotlightColors = [
    { color: "rgba(49, 95, 140, 0.2)", darkColor: "rgba(49, 95, 140, 0.25)" }, // Primary brand color
    { color: "rgba(104, 219, 255, 0.15)", darkColor: "rgba(104, 219, 255, 0.2)" }, // Highlight color
    { color: "rgba(49, 95, 140, 0.15)", darkColor: "rgba(49, 95, 140, 0.2)" }, // Primary variant
  ]
